...
<head>
    ...
    <title>Restablecer Contraseña - La Botica Natural</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="body">
            ...
            <p>Para elegir una nueva contraseña, haz clic en el siguiente botón. Este enlace caducará en 60 minutos:</p>
            
            <div class="button-container">
                <a href="{{ $enlace }}" class="btn-primary" target="_blank">Restablecer Contraseña</a>
            </div>
